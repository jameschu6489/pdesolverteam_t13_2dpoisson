...
class Options_poisson(object):
    def __init__(self):
        ...
        parser.add_argument('--epochs_LBFGS', type=int, default=10000, help='epochs for LBFGS optimizer')
        ...
        parser.add_argument('--n_b', type=int, default=1024, help='number of boundary point samples on the every axis')
        self.parser = parser
